...
////// Emissive:
                ...
                float node_3073_if_leA = step(_GammaLinear,1.0);
                float node_3073_if_leB = step(1.0,_GammaLinear);
                float node_2069 = 0.0;
                float3 emissive = (_Ramp_var.rgb*_FinalPower*_FinalColor.rgb*(lerp((node_3073_if_leA*0.15)+(node_3073_if_leB*node_2069),node_2069,node_3073_if_leA*node_3073_if_leB)+_GammaLinear));
