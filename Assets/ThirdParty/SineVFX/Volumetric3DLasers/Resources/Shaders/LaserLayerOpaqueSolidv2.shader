...
////// Emissive:
                ...
                float4 node_822 = _Time;
                float2 node_3759 = (UV+(node_822.g*_Noise02ScrollSpeed)*float2(1,0));
                float4 _Noise02_var = tex2D(_Noise02,TRANSFORM_TEX(node_3759, _Noise02));
