...
////// Lighting:
////// Emissive:
                float4 node_9571 = _Time;
                float2 node_7138 = ((i.uv0+i.uv0.b)+node_9571.g*float2(0,0.05));
                ...
                float2 node_536 = ((i.uv0+i.uv0.b)+node_9571.g*float2(0,1));
