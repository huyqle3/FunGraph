...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0,fgcg:0,fgcb:0,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:True,fnfb:True,fsmp:False;n:type:ShaderForge.SFN_Final,id:4795,x:33525,y:32766,varname:node_4795,prsc:2|emission-3653-OUT,alpha-219-OUT,voffset-8637-OUT;n:type:ShaderForge.SFN_Tex2d,id:8325,x:32618,y:32423,ptovrint:False,ptlb:Ramp,ptin:_Ramp,varname:node_8325,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-4925-OUT;n:type:ShaderForge.SFN_Append,id:4925,x:32446,y:32423,varname:node_4925,prsc:2|A-4141-R,B-3352-OUT;n:type:ShaderForge.SFN_Vector1,id:3352,x:32238,y:32495,varname:node_3352,prsc:2,v1:0;n:type:ShaderForge.SFN_Tex2dAsset,id:7971,x:30628,y:32223,ptovrint:False,ptlb:ComTex,ptin:_ComTex,varname:node_7971,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:9218,x:31130,y:32042,varname:node_9218,prsc:2,ntxv:0,isnm:False|UVIN-4218-OUT,TEX-7971-TEX;n:type:ShaderForge.SFN_Multiply,id:3653,x:32999,y:32467,varname:node_3653,prsc:2|A-8325-RGB,B-6740-OUT;n:type:ShaderForge.SFN_Multiply,id:4546,x:32701,y:32959,varname:node_4546,prsc:2|A-9218-G,B-4141-A,C-9886-OUT,D-2081-B;n:type:ShaderForge.SFN_Slider,id:6740,x:32461,y:32615,ptovrint:False,ptlb:Final Power,ptin:_FinalPower,varname:node_6740,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:5,max:10;n:type:ShaderForge.SFN_VertexColor,id:4141,x:31061,y:32532,varname:node_4141,prsc:2;n:type:ShaderForge.SFN_Slider,id:9886,x:32297,y:33070,ptovrint:False,ptlb:Opacity Boost,ptin:_OpacityBoost,varname:node_9886,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:4,max:4;n:type:ShaderForge.SFN_Clamp01,id:219,x:32876,y:32959,varname:node_219,prsc:2|IN-4546-OUT;n:type:ShaderForge.SFN_TexCoord,id:1500,x:29887,y:31519,varname:node_1500,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Multiply,id:8637,x:32664,y:33488,varname:node_8637,prsc:2|A-5330-OUT,B-2946-OUT,C-1205-OUT;n:type:ShaderForge.SFN_Slider,id:1205,x:32075,y:33673,ptovrint:False,ptlb:Offset Power,ptin:_OffsetPower,varname:node_1205,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:4;n:type:ShaderForge.SFN_OneMinus,id:2946,x:31824,y:33298,varname:node_2946,prsc:2|IN-4141-R;n:type:ShaderForge.SFN_Add,id:8462,x:30370,y:31661,varname:node_8462,prsc:2|A-531-OUT,B-1922-OUT;n:type:ShaderForge.SFN_Time,id:7717,x:29897,y:31739,varname:node_7717,prsc:2;n:type:ShaderForge.SFN_Multiply,id:1922,x:30162,y:31764,varname:node_1922,prsc:2|A-7717-T,B-5717-OUT;n:type:ShaderForge.SFN_Slider,id:5717,x:29740,y:31884,ptovrint:False,ptlb:Scroll Speed,ptin:_ScrollSpeed,varname:node_5717,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-4,cur:0,max:4;n:type:ShaderForge.SFN_Append,id:4218,x:30654,y:31797,varname:node_4218,prsc:2|A-8462-OUT,B-5134-OUT;n:type:ShaderForge.SFN_FragmentPosition,id:3446,x:29946,y:33069,varname:node_3446,prsc:2;n:type:ShaderForge.SFN_Append,id:8458,x:30684,y:33019,varname:node_8458,prsc:2|A-3841-G,B-3841-B;n:type:ShaderForge.SFN_Append,id:5192,x:30684,y:33166,varname:node_5192,prsc:2|A-3841-B,B-3841-R;n:type:ShaderForge.SFN_Append,id:7532,x:30684,y:33317,varname:node_7532,prsc:2|A-3841-R,B-3841-G;n:type:ShaderForge.SFN_Tex2dAsset,id:2243,x:30895,y:33512,ptovrint:False,ptlb:World Offset Noise,ptin:_WorldOffsetNoise,varname:node_6395,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:2396,x:31196,y:33022,varname:node_6397,prsc:2,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-8458-OUT,TEX-2243-TEX;n:type:ShaderForge.SFN_Tex2d,id:608,x:31196,y:33169,varname:node_2119,prsc:2,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-5192-OUT,TEX-2243-TEX;n:type:ShaderForge.SFN_Tex2d,id:963,x:31196,y:33320,varname:node_7954,prsc:2,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-7532-OUT,TEX-2243-TEX;n:type:ShaderForge.SFN_Panner,id:1292,x:30956,y:32919,varname:node_1292,prsc:2,spu:-0.5,spv:0|UVIN-8458-OUT;n:type:ShaderForge.SFN_Panner,id:2240,x:30956,y:33068,varname:node_2240,prsc:2,spu:-0.5,spv:0|UVIN-5192-OUT;n:type:ShaderForge.SFN_Panner,id:4580,x:30956,y:33217,varname:node_4580,prsc:2,spu:0.25,spv:0.25|UVIN-7532-OUT;n:type:ShaderForge.SFN_ObjectPosition,id:7853,x:29946,y:33216,varname:node_7853,prsc:2;n:type:ShaderForge.SFN_ComponentMask,id:3841,x:30342,y:33145,varname:node_3841,prsc:2,cc1:0,cc2:1,cc3:2,cc4:-1|IN-1408-OUT;n:type:ShaderForge.SFN_Subtract,id:1408,x:30172,y:33145,varname:node_1408,prsc:2|A-3446-XYZ,B-7853-XYZ;n:type:ShaderForge.SFN_Append,id:5330,x:31416,y:33144,varname:node_5330,prsc:2|A-2396-R,B-608-G,C-963-B;n:type:ShaderForge.SFN_RemapRange,id:2930,x:31824,y:33134,varname:node_2930,prsc:2,frmn:0,frmx:1,tomn:-1,tomx:1|IN-5330-OUT;n:type:ShaderForge.SFN_Tex2d,id:2081,x:31130,y:32205,varname:node_2081,prsc:2,ntxv:0,isnm:False|TEX-7971-TEX;n:type:ShaderForge.SFN_Add,id:5134,x:30370,y:31814,varname:node_5134,prsc:2|A-1500-V,B-4141-G;n:type:ShaderForge.SFN_Multiply,id:531,x:30141,y:31450,varname:node_531,prsc:2|A-1500-U,B-2355-OUT;n:type:ShaderForge.SFN_ValueProperty,id:2355,x:29887,y:31368,ptovrint:False,ptlb:Tiling,ptin:_Tiling,varname:node_2355,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.5;proporder:8325-7971-6740-9886-1205-5717-2243-2355;pass:END;sub:END;*/

Shader "Sine VFX/FireDartsOriginal" {
    Properties {
        _Ramp ("Ramp", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float3 node_5330 = float3(node_6397.r,node_2119.g,node_7954.b);
                v.vertex.xyz += (node_5330*(1.0 - o.vertexColor.r)*_OffsetPower);
...
////// Emissive:
                ...
                float2 node_4218 = float2(((i.uv0.r*_Tiling)+(node_7717.g*_ScrollSpeed)),(i.uv0.g+i.vertexColor.g));
