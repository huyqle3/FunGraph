    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2147 = 0.0;
                clip(((_OpacityRemap1 + ( (_OpacityCutoff_var.r - node_2147) * (_OpacityRemap2 - _OpacityRemap1) ) / (1.0 - node_2147))-(1.0 - saturate(_Progress))) - 0.5);
////// Lighting:
////// Emissive:
