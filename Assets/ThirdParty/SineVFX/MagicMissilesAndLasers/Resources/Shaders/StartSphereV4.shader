...
Shader "Sine VFX/StartSphereV4" {
    Properties {
        ...
        _MaskPower ("Mask Power", Range(0, 10)) = 2
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Emissive:
                ...
                float4 node_9641 = _Time;
                float2 node_8264 = (i.uv0+node_9641.g*float2(0,-2));
                float4 node_8394 = tex2D(_Noise02,TRANSFORM_TEX(node_8264, _Noise02));
                float2 node_4927 = float2((((node_3983*node_3983)*saturate((node_2453.r+_SpaceTex_var.r))*node_8394.r*_MaskPower)+(1.0-max(0,dot(normalDirection, viewDirection)))),0.0);
