...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0,fgcg:0,fgcb:0,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:True,fnfb:True,fsmp:False;n:type:ShaderForge.SFN_Final,id:4795,x:32724,y:32653,varname:node_4795,prsc:2|emission-8013-OUT,alpha-8010-OUT,clip-2614-OUT,voffset-4910-OUT;n:type:ShaderForge.SFN_Multiply,id:8013,x:32134,y:32485,varname:node_8013,prsc:2|A-9604-RGB,B-775-R,C-5941-RGB,D-7371-OUT,E-245-OUT;n:type:ShaderForge.SFN_Tex2d,id:775,x:31838,y:32478,ptovrint:False,ptlb:Mask,ptin:_Mask,varname:node_775,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:5941,x:31838,y:32660,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_5941,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Slider,id:7371,x:31681,y:32825,ptovrint:False,ptlb:Final Power,ptin:_FinalPower,varname:node_7371,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:2,max:10;n:type:ShaderForge.SFN_Tex2d,id:1344,x:30890,y:32297,ptovrint:False,ptlb:Noise 01,ptin:_Noise01,varname:node_1344,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-4575-UVOUT;n:type:ShaderForge.SFN_Panner,id:4575,x:30720,y:32297,varname:node_4575,prsc:2,spu:0,spv:1|UVIN-7717-UVOUT,DIST-6167-OUT;n:type:ShaderForge.SFN_Time,id:8289,x:30274,y:32328,varname:node_8289,prsc:2;n:type:ShaderForge.SFN_Multiply,id:6167,x:30472,y:32386,varname:node_6167,prsc:2|A-8289-T,B-3490-OUT;n:type:ShaderForge.SFN_ValueProperty,id:3490,x:30274,y:32466,ptovrint:False,ptlb:Scroll Speed,ptin:_ScrollSpeed,varname:node_3490,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;n:type:ShaderForge.SFN_TexCoord,id:7717,x:30472,y:32233,varname:node_7717,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Multiply,id:8910,x:32140,y:32917,varname:node_8910,prsc:2|A-2846-OUT,B-6554-OUT,C-775-R,D-245-OUT;n:type:ShaderForge.SFN_Slider,id:6554,x:31681,y:33063,ptovrint:False,ptlb:Opacity Boost,ptin:_OpacityBoost,varname:node_6554,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:2,max:4;n:type:ShaderForge.SFN_Multiply,id:4910,x:32099,y:33238,varname:node_4910,prsc:2|A-5694-OUT,B-9293-OUT,C-8343-OUT;n:type:ShaderForge.SFN_NormalVector,id:9293,x:31830,y:33301,prsc:2,pt:False;n:type:ShaderForge.SFN_Slider,id:8343,x:31673,y:33468,ptovrint:False,ptlb:Offset Power,ptin:_OffsetPower,varname:node_8343,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.1,max:1;n:type:ShaderForge.SFN_Set,id:6740,x:31169,y:32242,varname:Result,prsc:2|IN-1344-R;n:type:ShaderForge.SFN_Get,id:8577,x:31407,y:32218,varname:node_8577,prsc:2|IN-6740-OUT;n:type:ShaderForge.SFN_Get,id:2846,x:31803,y:32981,varname:node_2846,prsc:2|IN-6740-OUT;n:type:ShaderForge.SFN_Get,id:5694,x:31809,y:33249,varname:node_5694,prsc:2|IN-6740-OUT;n:type:ShaderForge.SFN_Tex2d,id:7425,x:31516,y:33897,ptovrint:False,ptlb:Opacity Cutoff,ptin:_OpacityCutoff,varname:node_6065,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Subtract,id:2614,x:32133,y:33901,varname:node_2614,prsc:2|A-6580-OUT,B-5884-OUT;n:type:ShaderForge.SFN_OneMinus,id:5884,x:31516,y:33701,varname:node_5884,prsc:2|IN-4672-OUT;n:type:ShaderForge.SFN_RemapRangeAdvanced,id:6580,x:31784,y:33964,varname:node_6580,prsc:2|IN-7425-R,IMIN-8935-OUT,IMAX-1945-OUT,OMIN-354-OUT,OMAX-3750-OUT;n:type:ShaderForge.SFN_Vector1,id:8935,x:31516,y:34062,varname:node_8935,prsc:2,v1:0;n:type:ShaderForge.SFN_Vector1,id:1945,x:31516,y:34128,varname:node_1945,prsc:2,v1:1;n:type:ShaderForge.SFN_ValueProperty,id:354,x:31516,y:34208,ptovrint:False,ptlb:Opacity Remap 1,ptin:_OpacityRemap1,varname:node_714,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;n:type:ShaderForge.SFN_ValueProperty,id:3750,x:31516,y:34284,ptovrint:False,ptlb:Opacity Remap 2,ptin:_OpacityRemap2,varname:_OpacityRemap2,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;n:type:ShaderForge.SFN_Slider,id:5736,x:30465,y:33551,ptovrint:False,ptlb:Progress,ptin:_Progress,varname:node_5736,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Clamp01,id:4672,x:30781,y:33551,varname:node_4672,prsc:2|IN-5736-OUT;n:type:ShaderForge.SFN_Fresnel,id:166,x:31336,y:32887,varname:node_166,prsc:2|EXP-7199-OUT;n:type:ShaderForge.SFN_Slider,id:7199,x:30948,y:32997,ptovrint:False,ptlb:Fresnel Exp,ptin:_FresnelExp,varname:node_7199,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:4;n:type:ShaderForge.SFN_OneMinus,id:245,x:31511,y:32887,varname:node_245,prsc:2|IN-166-OUT;n:type:ShaderForge.SFN_Tex2d,id:9604,x:31838,y:32291,ptovrint:False,ptlb:Ramp,ptin:_Ramp,varname:node_9604,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-9258-OUT;n:type:ShaderForge.SFN_Append,id:9258,x:31603,y:32238,varname:node_9258,prsc:2|A-8577-OUT,B-236-OUT;n:type:ShaderForge.SFN_Vector1,id:236,x:31428,y:32272,varname:node_236,prsc:2,v1:0;n:type:ShaderForge.SFN_Clamp01,id:8010,x:32316,y:32917,varname:node_8010,prsc:2|IN-8910-OUT;proporder:775-5941-7371-1344-3490-6554-8343-7425-354-3750-5736-7199-9604;pass:END;sub:END;*/

Shader "Sine VFX/LaserConMeshv3" {
    Properties {
        _Mask ("Mask", 2D) = "white" {}
...
////// Emissive:
                ...
                float Result = _Noise01_var.r;
                float2 node_9258 = float2(Result,0.0);
                float4 _Ramp_var = tex2D(_Ramp,TRANSFORM_TEX(node_9258, _Ramp));
                float4 _Mask_var = tex2D(_Mask,TRANSFORM_TEX(i.uv0, _Mask));
                float node_245 = (1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelExp));
                float3 emissive = (_Ramp_var.rgb*_Mask_var.r*_Color.rgb*_FinalPower*node_245);
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,saturate((Result*_OpacityBoost*_Mask_var.r*node_245)));
