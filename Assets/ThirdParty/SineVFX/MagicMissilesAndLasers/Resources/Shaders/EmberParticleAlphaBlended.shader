...
////// Emissive:
                ...
                float node_6517 = saturate((_Mask_var.r-(1.0 - i.vertexColor.a)));
                ...
                fixed4 finalRGBA = fixed4(finalColor,saturate((node_6517*_OpacityBoost)));
