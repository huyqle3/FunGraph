...
////// Lighting:
////// Emissive:
                float4 node_6209 = _Time;
                float2 node_2263 = (i.uv0+node_6209.g*float2(0,-0.25));
                ...
                float2 node_1025 = ((i.uv0+node_6209.g*float2(0,-1))+node_1158);
                float4 _Noise01_var = tex2D(_Noise01,TRANSFORM_TEX(node_1025, _Noise01));
                float2 node_3699 = ((i.uv0+node_6209.g*float2(0,-0.5))+node_1158);
