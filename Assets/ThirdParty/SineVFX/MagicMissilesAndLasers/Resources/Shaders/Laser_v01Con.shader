    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float node_8613_if_leA = step(distance(i.posWorld.rgb,_Position.rgb),_Distance);
                float node_8613_if_leB = step(_Distance,distance(i.posWorld.rgb,_Position.rgb));
                float node_922 = 0.0;
                ...
                clip((lerp((node_8613_if_leA*1.0)+(node_8613_if_leB*node_922),node_922,node_8613_if_leA*node_8613_if_leB)*((_OpacityRemap1 + ( (_OpacityCutoff_var.r - node_8501) * (_OpacityRemap2 - _OpacityRemap1) ) / (1.0 - node_8501))-(1.0 - node_1684))) - 0.5);
////// Lighting:
////// Emissive:
