...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        public bool setControllerAsParent;
        ...
        {
            Transform controllerTrans = currentGrabbingObject.GetComponent<Transform>();

            if (setControllerAsParent == true)
            {
                this.gameObject.transform.SetParent(controllerTrans, true);
            }
            else
            {
                return;
